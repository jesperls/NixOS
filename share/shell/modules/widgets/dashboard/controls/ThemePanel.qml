            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            ToggleRow {
                                ...
                                onToggled: value => {
                                    if (value !== Config.theme.lightMode) {
                                        GlobalStates.markThemeChanged();
                            ...
                            ToggleRow {
                                ...
                                onToggled: value => {
                                    if (value !== Config.theme.oledMode) {
                                        GlobalStates.markThemeChanged();
                                        Config.theme.oledMode = value;
                                    }
                                }
                            }
                    ...
                    Item {
                        ...
                        property string settingsSection: "shadow"
                        Layout.fillWidth: true
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            ToggleRow {
                                label: "Colors Follow Wallpaper"
                                checked: Config.theme.dynamicColors ?? true
                                onToggled: value => {
                                    if (value !== Config.theme.dynamicColors) {
                                        GlobalStates.markThemeChanged();
                                        Config.theme.dynamicColors = value;
                                        if (value && GlobalStates.wallpaperManager) {
                                            GlobalStates.wallpaperManager.runMatugenForCurrentWallpaper(true);
                                        }
                                    }
                                }
                            }
