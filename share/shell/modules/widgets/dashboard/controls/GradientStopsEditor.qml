...
Item {
    ...
    readonly property var defaultBaseColors: ({
        ...
        focus: "surfaceBright",
        primary: "primary",
        primaryfocus: "overPrimaryContainer",
        overprimary: "overPrimary",
        secondary: "secondary",
        secondaryfocus: "overSecondaryContainer",
        oversecondary: "overSecondary",
        tertiary: "tertiary",
        tertiaryfocus: "overTertiaryContainer",
        overtertiary: "overTertiary",
        error: "error",
        errorfocus: "overBackground",
        overerror: "overError"
    })

    readonly property var defaultGradient: [[defaultBaseColors[variantId] || "surface", 0.0]]
