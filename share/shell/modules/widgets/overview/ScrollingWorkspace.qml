    ...
    Item {
        ...
        Item {
            ...
            TapHandler {
                ...
                onDoubleTapped: {
                    Compositor.dispatch(`workspace ${root.workspaceId}`);
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        border.color: windowDelegate.isSelected ? Colors.tertiary : Styling.srItem("overprimary")
                    ...
                    MouseArea {
                        ...
                        onClicked: mouse => {
                            ...
                            if (mouse.button === Qt.LeftButton && !windowDelegate.dragging) {
                                Compositor.dispatch(`focuswindow address:${windowDelegate.windowData.address}`);
                            } else if (mouse.button === Qt.MiddleButton) {
                                Compositor.dispatch(`closewindow address:${windowDelegate.windowData.address}`);
                            }
                        }
