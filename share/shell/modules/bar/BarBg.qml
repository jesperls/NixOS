...
Item {
    ...
    Item {
        ...
        Rectangle {
            ...
            width: root.splitActive ? Math.max(0, Math.min(root.splitStart, root.width)) : root.width
            height: root.height
            topRightRadius: root.splitActive ? Styling.radius(4) : 0
            bottomRightRadius: root.splitActive ? Styling.radius(4) : 0
        }
