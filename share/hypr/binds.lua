...
bind_exec(mainMod, "Super_L", "pangu run launcher", { release = true })

bind_exec(mainMod, "A", "pangu run dashboard")
bind_exec(mainMod, "N", "pangu run notes")
bind_exec(mainMod, "Tab", "pangu run overview")
bind_exec(mainMod, "Escape", "pangu run powermenu")
bind_exec(mainMod, "G", "pangu run gamemode")
...
bind_exec(mainMod, "V", "pangu run clipboard")
bind_exec(mainMod .. " SHIFT", "C", "hyprpicker -a")

bind_exec("", "Print", "pangu run screenshot")
